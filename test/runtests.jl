...
const ISOLATED_TEST_FILES = String[
    ...
    "regression_package_reload_boundary.jl",
    "unit_executor_loading.jl",
    "unit_server_runtime_state.jl",
    "unit_executor_protocol.jl",
    "integration_executor_loop.jl",
    "integration_executor_lifecycle.jl",
    "integration_listener_execution.jl",
    "regression_executor_failure.jl",
    "integration_executor_cache_clear.jl",
    "integration_executor_restart.jl",
    "unit_server_management_protocol.jl",
    "integration_restart_cli.jl",
    "unit_conductor_restart_operation.jl",
    "regression_conductor_restart_all.jl",
    "unit_conductor_restart_protocol.jl",
    "integration_restart_all_cli.jl",
    "integration_restart_package_reload.jl",
    "integration_conductor_executor_restart.jl",
    "integration_conductor_restart_all.jl",
    "integration_listener_shutdown.jl",
]
